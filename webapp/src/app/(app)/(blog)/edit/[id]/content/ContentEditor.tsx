...
export default function ContentEditor() {
	...
	return (
		<div className='mx-auto my-8 w-[56rem] py-8'>
			...
			<div className='mb-16 grid grid-cols-3 divide-y divide-neutral-800 rounded-md border border-neutral-800'>
				...
				<MetadataInput label='Featured Image:' className='col-span-3'>
					<div className='mt-4 h-96 w-full rounded-3xl bg-neutral-900' />
				</MetadataInput>
			</div>
